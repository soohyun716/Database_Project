...
public class StartPage extends JFrame {
        ...
        public StartPage() {
            ...
            // 교수 버튼 이미지
            ImageIcon professorImage_temp = new ImageIcon(StartPage.class.getResource("/images/professorImage.png"));
            ...
            // 학생 버튼 이미지
            ImageIcon studentImage_temp = new ImageIcon(StartPage.class.getResource("/images/studentImage.png"));
            ...
            administratorPanel.setPreferredSize(new Dimension(100, 50)); // Set preferred size for the South panel
